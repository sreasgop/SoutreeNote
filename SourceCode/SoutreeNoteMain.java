...
class FileOperation {
	...
	boolean newFileFlag;
	String fileName;
	String applicationTitle = "SoutreeNote";
	...
	FileOperation(SoutreeNoteMain npd) {
		this.npd = npd;
...
public class SoutreeNoteMain implements ActionListener, MenuConstants {
	...
	public void actionPerformed(ActionEvent ev) {
		...
		////////////////////////////////////
			...
			if (SoutreeNoteMain.this.ta.getText().length() == 0)
				return; // text box have no text
			if (findReplaceDialog == null)
				findReplaceDialog = new FindDialog(SoutreeNoteMain.this.ta);
			findReplaceDialog.showDialog(SoutreeNoteMain.this.f, true);// find
		}
		////////////////////////////////////
		...
		////////////////////////////////////
			...
			if (findReplaceDialog == null)
				findReplaceDialog = new FindDialog(SoutreeNoteMain.this.ta);
			findReplaceDialog.showDialog(SoutreeNoteMain.this.f, false);// replace
		}
		////////////////////////////////////
		...
		////////////////////////////////////
			...
			if (fontDialog.showDialog(SoutreeNoteMain.this.f, "Choose a font"))
				SoutreeNoteMain.this.ta.setFont(fontDialog.createFont());
		}
		////////////////////////////////////
		...
		////////////////////////////////////
			...
			JOptionPane.showMessageDialog(SoutreeNoteMain.this.f, aboutText, "SoutreeNote!", JOptionPane.INFORMATION_MESSAGE);
		} else
	...
	void showBackgroundColorDialog() {
		...
		if (backgroundDialog == null)
			backgroundDialog = JColorChooser.createDialog(SoutreeNoteMain.this.f,
					formatBackground,
					false,
					bcolorChooser,
					new ActionListener() {
						public void actionPerformed(ActionEvent evvv) {
							SoutreeNoteMain.this.ta.setBackground(bcolorChooser.getColor());
						}
					},
					null);
	...
	void showForegroundColorDialog() {
		...
		if (foregroundDialog == null)
			foregroundDialog = JColorChooser.createDialog(SoutreeNoteMain.this.f,
					formatForeground,
					false,
					fcolorChooser,
					new ActionListener() {
						public void actionPerformed(ActionEvent evvv) {
							SoutreeNoteMain.this.ta.setForeground(fcolorChooser.getColor());
						}
					},
					null);
	...
	void createMenuBar(JFrame f) {
		...
		MenuListener editMenuListener = new MenuListener() {
			public void menuSelected(MenuEvent evvvv) {
				...
				if (SoutreeNoteMain.this.ta.getSelectionStart() == ta.getSelectionEnd()) {
...
interface MenuConstants {
	...
	final String helpAboutNotepad = "About SoutreeNote";

	final String aboutText = "<html><big>SoutreeNote, written in Java</big><hr><hr>"
			+ "<p align=right>Author: CSGS!"
			+ "<hr><p align=left>JDK21 has been used to compile the source code.<br><br>"
			+ "<strong>Thankyou for using SoutreeNote</strong><br>"
			+ "SoutreeNote © 2024 All Rights Reserved.<p align=center>";
//			+ "<hr><em><big>chandrasreasgop@gmail.com</big></em><hr><html>";
}